...
TextRenderer::TextRenderer(TextureManager& TextureManager, int w, int h) : textureManager(TextureManager), msdf("engine/srcs/Font/msdf.vs", "engine/srcs/Font/msdf.fs"), screenW(w), screenH(h) {
